...
![conftest](https://repo.x-cmd.io/conftest.svg?lang=zh)
...
合计: **13,607** 行代码（覆盖前 5 种语言、共 **240** 个文件）。
...
- **上游仓库**: <https://github.com/open-policy-agent/conftest>
- **官网**: <https://conftest.dev>
- **许可证**: NOASSERTION

## 发布

- **最新版本**: `v0.70.0` (2026-09-12)
- **最近提交**: 2026-09-13
- **Release 含资产**: 17 个

## 流行度

- **Star**: 3,262 · **Fork**: 361 · **开放 issue**: 381 · **贡献者**: 140

## 累计统计

- **发布数**: 99 · **已合并 PR**: 839 · **开放 PR**: 13 · **已关闭 issue**: 350 · **开放 issue**: 31 · **提交数**: 1292

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-18 | 1 | 12 | 5 | 0 | 0 | 21 |
| last60d | 2026-07-19 | 2 | 32 | 6 | 1 | 2 | 39 |
| 90d | 2026-06-19 | 2 | 42 | 6 | 1 | 2 | 48 |
| last180d | 2026-03-21 | 6 | 71 | 8 | 7 | 2 | 75 |
| 360d | 2025-09-22 | 11 | 144 | 10 | 15 | 4 | 144 |
| last720d | 2024-09-27 | 20 | 256 | 12 | 41 | 10 | 272 |
...
conftest 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `conftest` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/conftest.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260917.yml` · 2026-09-17T06:25:26Z._
